...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Examples = __webpack_require__(247);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormComponent = __webpack_require__(218);

	var _FormComponent2 = _interopRequireDefault(_FormComponent);

	var _WeatherMessage = __webpack_require__(219);

	var _WeatherMessage2 = _interopRequireDefault(_WeatherMessage);

	var _openWeatherMap = __webpack_require__(220);
	...
	var Weather = function (_Component) {
	  ...
	  _createClass(Weather, [{
	    ...
	    value: function handleSearch(location) {
	      ...
	      _openWeatherMap2.default.getTemp(location).then(function (passedData) {
	        that.setState({
	          location: location,
	          temp: passedData,
	          loading: false
	    ...
	    value: function render() {
	      ...
	      function renderMessage() {
	        if (that.state.loading === true) {
	          ...
	          return _react2.default.createElement(_WeatherMessage2.default, { location: that.state.location, temp: that.state.temp });
	        }
	      }
	      ...
	      return _react2.default.createElement(
	        ...
	        null,
	        'Weather Page',
	        _react2.default.createElement(_FormComponent2.default, { passToParent: this.handleSearch.bind(this) }),
	        _react2.default.createElement(
	          'p',
	          null,
	          _react2.default.createElement(
	            'strong',
	            null,
	            'Note: this in Promises.'
	          ),
	          ' The keyword "this" losses its context inside a promise. Because of that we need to use var that = this in the parent function.'
	        ),
	        _react2.default.createElement(
	          'p',
	          null,
	          _react2.default.createElement(
	            'strong',
	            null,
	            'Note: arrow functions take this from its parent.'
	          ),
	          ' Normal functions don\'t; that\'s why we are forced to use bind or the var that=this trick. Using arrow functions we can save us that burden.'
	        ),
	        renderMessage()
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormComponent = function (_Component) {
	  ...
	  _createClass(FormComponent, [{
	    key: 'handleSubmit',
	    value: function handleSubmit(eventObject) {
	    ...
	    key: 'handleChange',
	    value: function handleChange(eventObject) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          ' We have two options to handle the form input:'
	        ),
	        _react2.default.createElement(
	          'ol',
	          null,
	          _react2.default.createElement(
	            'li',
	            null,
	            'In one step, we can use onSubmit in the form tag and get the input using this.refs.name.value and then handle it.'
	          ),
	          _react2.default.createElement(
	            'li',
	            null,
	            'In two steps, we first call onChange in the input field, then this.eventObject.target.value to get the value there. Then we use onSubmit in the form tag and handle there the input value got.'
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseURL = 'http://api.openweathermap.org/data/2.5/weather?appid=b68279dd9e3ec9121ef0576990607535&units=metric';

	var APIkey = 'b68279dd9e3ec9121ef0576990607535';
	...
	module.exports = {
	  getTemp: function getTemp(location) {
	    ...
	    return _axios2.default.get(finalURL).then(function (passedData) {
	      //validation
...
/***/ function(module, exports, __webpack_require__) {
	...
	axios.isCancel = __webpack_require__(240);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createError = __webpack_require__(230);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isCancel = __webpack_require__(240);
	var defaults = __webpack_require__(226);
